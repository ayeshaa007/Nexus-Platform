  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'Total Investment', value: '$4.3M', icon: <DollarSign size={20} className="text-primary-600" />, bg: 'bg-primary-100' },
          { label: 'Active Deals', value: '8', icon: <TrendingUp size={20} className="text-secondary-600" />, bg: 'bg-secondary-100' },
          { label: 'Portfolio Companies', value: '12', icon: <Users size={20} className="text-accent-600" />, bg: 'bg-accent-100' },
          { label: 'Closed This Month', value: '2', icon: <Calendar size={20} className="text-success-600" />, bg: 'bg-green-100' },
        ].map((stat) => (
          <Card key={stat.label}>
            <CardBody>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  {['Startup', 'Amount', 'Equity', 'Status', 'Stage', 'Last Activity', ''].map((h) => (
                    <th
                      key={h}
