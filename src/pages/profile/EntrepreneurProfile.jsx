            ...
            <CardBody>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-1">
                    The {entrepreneur.industry} market is experiencing significant growth, with a
                    projected CAGR of 14.5% through 2027. Our solution addresses key pain points in
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-1">
                    ...
                    technology with deep industry expertise, resulting in superior outcomes for our
                    customers.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-3 border-t border-gray-100">
                  ...
                  <div className="mt-2 space-y-2">
                    {[
                      ['Pre-seed', 'bg-green-100 text-green-800', 'Completed'],
                      ['Seed', 'bg-green-100 text-green-800', 'Completed'],
                      ['Series A', 'bg-yellow-100 text-yellow-800', 'In Progress'],
                    ].map(([stage, cls, label]) => (
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-3">
                {[
                  ['Pitch Deck', 'Updated 2 months ago'],
                  ['Business Plan', 'Updated 1 month ago'],
                  ['Financial Projections', 'Updated 2 weeks ago'],
                ].map(([docName, updated]) => (
                  <div
                    key={docName}
              ...
              {!isCurrentUser && isInvestor && (
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <p className="text-sm text-gray-500">
                    Request access to detailed documents and financials by sending a collaboration
                    request.
                  </p>
                  <Button
